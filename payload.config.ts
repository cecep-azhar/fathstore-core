  ...
  collections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'checkoutCurrency', type: 'select', options: [{ label: 'IDR', value: 'IDR' }, { label: 'USD', value: 'USD' }, { label: 'SGD', value: 'SGD' }], defaultValue: 'SGD' },
        { name: 'exchangeRateAtCheckout', type: 'number', defaultValue: 1 },
        ...
        { name: 'paymentStatus', type: 'select', options: [{ label: 'Pending', value: 'pending' }, { label: 'Review', value: 'payment_review' }, { label: 'Paid', value: 'paid' }, { label: 'Failed', value: 'failed' }, { label: 'Refunded', value: 'refunded' }], defaultValue: 'pending' },
        { name: 'fulfillmentStatus', type: 'select', options: [{ label: 'Unfulfilled', value: 'unfulfilled' }, { label: 'Processing', value: 'processing' }, { label: 'Shipped', value: 'shipped' }, { label: 'Completed', value: 'completed' }, { label: 'Complaint', value: 'complaint' }], defaultValue: 'unfulfilled' },
        { name: 'paymentMethod', type: 'select', options: [{ label: 'QRIS', value: 'qris' }, { label: 'Bank Transfer', value: 'bank_transfer' }, { label: 'Xendit', value: 'xendit' }, { label: 'COD', value: 'cod' }, { label: 'Other', value: 'other' }], defaultValue: 'other' },
        ...
        { name: 'shippingAddress', type: 'group', fields: [
          ...
          { name: 'country', type: 'text', defaultValue: 'Singapore' },
        ]},
